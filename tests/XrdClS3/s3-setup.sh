...
if ! "$BINARY_DIR/tests/XrdClCurl/xrdscitokens-create-jwks" "$RUNDIR/issuer/issuer_public.pem" "$RUNDIR/issuer/issuer.jwks" "test_key"; then
...
url = s3://*
lib = $BINARY_DIR/libXrdClS3.$PLUGIN_SUFFIX
enable = true
