...
class PelicanChecksumFixture : public TransferFixture {
protected:
...
void
PelicanChecksumFixture::WriteString(const std::string &name, const std::string &contents)
{
    XrdCl::File fh;
...
void
PelicanChecksumFixture::VerifyString(const std::string &name, const std::string &contents)
{
    XrdCl::File fh;
